...
[encouraging an environment](/content/encouraging_environments)
...
- as with people everywhere, present-bias (quasi-hyperbolic fertilizer; tying odysseus to the mast; euler's equation)
  - https://www.povertyactionlab.org/evaluation/nudging-farmers-use-fertilizer-experimental-evidence-kenya
- lack of regulation and information: vaccines, insurance
- mixed occupation, lack of specialization
- adjacent insurance (microclimates) and insurance in general (shared risk mitigation, social proof, pigs)
...
- colonization of africa
  - capitals established, little impact
- distance from places, china
  - roads available, little impact
- haciendas (mita)
  - lack of protection or connection
- monasteries
  - what sprung up in their place?
- radio transmission of brazilian voting results
  - only where radios available

---> and what places *allow* assimilation?
