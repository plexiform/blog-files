...
export default () => {
  return (
    <Layout>
      <div style={{display: 'inline-block', float:'left', maxWidth:400}}>
...
<hr/>
      Web data science companies that uses data to create markets that empower people, with an emphasis on security.
<hr/>
 ...
 Music & mathematics<br/><br/>
      ...
      <div style={{
        ...
        <div>
          ...
          ✘ How to Code: Complex data <hr/>
          ✘ 6.00.2x <hr/>
          ✘ The Analytics Edge (15.071) <hr/>
          ✘ Stat 110 <hr/>
          ✘ Dataquest.io <hr/>
          ✘ Math for CS <hr/>
          ...
          ✘ 8.01 <hr/>
          ✘ Algorithmic Game Theory <hr/>
          ✘ Programming and Programming Languages  <hr/>
          ✘ Probability For the Enthusiastic Beginner (page 0/???) <hr/>
          ✘ Udi Manber's Algorithms (chapters 1-5) <hr/>
          ✘ Udi Manber's Algorithms (chapters 6 & 7) <hr/>
          ✘ Udi Manber's Algorithms (chapters 8 & 9) <hr/>
          ✘ MIT Algo. course <hr/>
          ✘ Python Stats+Prob <hr/>
          ✘ MIT Prob. course
          ✘ How to Prove It <hr/>
          ...
          ✘ R for Data Science <hr/>
          ✘ OHI Data Science Training <hr/>
          ✘ Swirl (R) <hr/>
        </div>
      </div>
     </Layout>
