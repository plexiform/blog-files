...
export default () => (
<Layout>
    <h2>From a position of utmost vulnerability</h2>
    <p>
    <h3>Where I'm at:</h3>
    <ul>
...
<br/>
    ...
    <div>
    <div style={{float:`left`, maxWidth:`50%`, display:`inline-block`}}>
      <h1>My Why's</h1>
        <ul>
          <li>He beat her while she was pregnant, pulled her by her hair, cheated on her and gave her an uncurable STD, committed fraud by claiming she was getting paid when in reality she got no money at all, had her lie to the government. He beat me until I was 14 and I stopped him as he tried to push me into the kitchen sink.</li>
          <li>M constantly siding with dad, despite our mother being treated as a second-class citizen in her own home, devalued and a financial hostage</li>
          <li>To harden myself</li>
          <li>To save lives</li>
          <li>To find joy and beauty in the moment</li>
          <li>To compete with the weakness within me</li>
          <li>To prove who anyone felt their chance was gone, wrong</li>
          <li>To prove anyone who'd talk past me like I don't belong, wrong</li>
          <li>To prove people who cast unsure looks when I mentioned my dreams, wrong</li>
          <li>To spit at any and all condescension from people who barely knew me, or did know me</li>
          <li>To defy people who drew conclusions from my physical appearance</li>
          <li>Denali and Aly...whatever her name was, brown chick, who laughed past me or ignored me</li>
          <li>Christ, at the lunch table</li>
          <li>Ms. Kwon</li>
          <li>Dad, for too many slights, yet who even still thinks I'm on M's reading level (or she on mine), who chooses to ignore most if not all of my input for his own</li>
          <li>N, for saying I "used to be" smart</li>
          <li></li>
          <li>To prove everyone who believed in me, right</li>
        </ul>
      </div>
      <div style={{display:`inline-block`, maxWidth:`50%`}}>
      <h1>Cookies, Big and Small</h1>
        <ul>
          <li>The skill of identifying with and befriending talented people</li>
          <li>Founding a graphic design webzine at the age of 12 or 13 that had over a dozen members</li>
          <li>Giving myself hope, as I filled entire journals with CBT and gratitude, pulling myself out of a decade-long slump</li>
          <li>Preparing for and getting accepted into CS</li>
          <li>Being the strongest in the AppAcad. prep course</li>
          <li>Beating my alcoholism (downing a fifth every other day)</li>
          <li>Losing >50 lbs, becoming healthier and stronger</li>
          <li>Identifying my interpersonal shortcomings, DBT, abuse, thereby becoming a more mindful, compassionate person</li>
          <li>Beating a drug addiction + withdrawal, and the incredible pain that caused </li>
          <li>Coding Space Invaders in DrRacket</li>
          <li>Staying late to work @ CS, when others left</li>
          <li>9th grade bio, studying and seeing it pay off</li>
          <li>Grinding to 27m agility and so many other 99's, getting to 59 in BDO</li>
          <li>The Google extension which I did without help</li>
          <li>Passing the CRUD qualifier (meaning I was good enough to graduate the class and put it on my resume)</li>
          <li>Learning and leading raids and extremes, clearing for people who wouldn't have done it without me</li>
          <li>Learning the Around the World, catching the ball on my neck, the rainbow, bouncing it off my shoulder, etc. </li>
          <li>Hours spent into the night working on DEDP, seeing it pay off in the areas I'd studied</li>
          <li></li>
        </ul>
      </div>
    </div>
...
<br/>
I'd identified with abuse, small frame, and as someone who'd been told all his life that he doesn't belong -- whether it was being kicked out of the magnet program I'd never wanted to be in in the first place, told to give up my interests, thrown into a mental clinic, and the rest of it. It's made me tough.
    </p>
    <p>
